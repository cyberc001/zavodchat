...
Клиент требует добавления своей видео-дорожки во все соединения WebRTC в данном канале. Можно указать требуемый битрейт исходящей видеодорожки (иначе ставится максимально допустимый в настройках сервера) - в бит/сек.

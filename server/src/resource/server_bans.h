...
{
public:
	server_bans_resource(webserver& ws, db_connection_pool& pool, const config& cfg);
...
{
public:
	server_ban_id_resource(webserver& ws, db_connection_pool& pool, const config& cfg,
